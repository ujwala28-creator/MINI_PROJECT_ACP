...
int main() {
    ...
    while (1) {
        ...
        switch (choice) {
            ...
            case 2: // Add Objects
            case 3: // Delete Objects (Uses the same drawing math, but fills with '_')
                {
                    ...
                    if (subChoice == 1) {
                        int x1, y1, x2, y2;
                        printf("Enter Start (Row Col) and End (Row Col) [0-%d, 0-%d]: ", ROWS-1, COLS-1);
